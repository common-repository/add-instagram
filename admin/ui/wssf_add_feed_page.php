...
<div id="wssf_notice_box">
  ...
  <ul class="tabs">
    ...
    <li class="tab-link current" data-tab="tab-5"><img src='<?php echo plugins_url( '/images/instagram.png', __FILE__); ?>' /></li>
  ...
  <div id="tab-5" class="tab-content current">
     ...
     <table class="form-table">
      <tr valign='top'>
        ...
        <td><label for="wssf_instagram_token">
          ...
          <p class="description"><?php _e( 'How to Get Instagram Access Token <a href="https://elfsight.com/blog/2016/05/how-to-get-instagram-access-token/" target="_blank">  Ckick Here </a>'); ?></p>
          </label>
        </td>
      </tr>
     <tr valign="top">
     ...
     <div class="accordion-section">
        <a class="accordion-section-title active" href="#accordion-2">Instagram Feed Settings</a>
        ...
        <div id="accordion-2" class="accordion-section-content open" style="display:block;">
         ...
         <table class="form-table">
            ...
            <tr valign='top'>
            <th scope='row'><?php _e('Enable Instagram Feed Settings');?></th>
            <td>
               <div class="onoffswitch">
...
<div class="accordion-section">
        <a class="accordion-section-title active" href="#accordion-3">Instagram Feed Design Settings</a>
